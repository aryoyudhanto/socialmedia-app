    ...
    return (
        <Layout>
            <div className="flex flex-col w-full h-screen">
                <div className="flex h-screen justify-end p-20">
                    <div className="flex flex-col w-[400px] ">
                        <div className="w-full mx-auto rounded-2xl bg-[#e5e5e5] h-[480px] p-8 shadow-2xl"                        >
            ...
            <div className="flex flex-col w-full h-screen">
                <div className="flex h-screen py-20 px-10">
                    <form
